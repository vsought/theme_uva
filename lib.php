...
function theme_uva_get_main_scss_content($theme)
{
    ...
    else if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_uva', 'preset', 0, '/', $filename)))
        // This preset file was fetched from the file area for theme_uva and not theme_boost (see the line above).
    ...
    $pre = file_get_contents($CFG->dirroot . '/theme/uva/scss/pre.scss');                                                         
    // // Post CSS - this is loaded AFTER the main scss but before the extra scss from the setting.
    $post = file_get_contents($CFG->dirroot . '/theme/uva/scss/post.scss');
